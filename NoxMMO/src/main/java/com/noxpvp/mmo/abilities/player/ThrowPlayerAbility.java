...
public class ThrowPlayerAbility extends BaseRangedPlayerAbility implements PVPAbility {
	...
	public AbilityResult<ThrowPlayerAbility> execute() {
		if (!mayExecute())
			return new AbilityResult<ThrowPlayerAbility>(this, false);
...
//			addEffectedEntity(e);
		...
		if (i > 0) {
			...
			return new AbilityResult<ThrowPlayerAbility>(this, true);
			
		} else return new AbilityResult<ThrowPlayerAbility>(this, false);
	}
