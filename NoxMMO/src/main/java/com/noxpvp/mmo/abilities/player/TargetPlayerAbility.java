...
public class TargetPlayerAbility extends BaseRangedPlayerAbility implements PassiveAbility<PlayerInteractEvent>, SilentAbility {
	 ...
	 */
	public AbilityResult<TargetPlayerAbility> execute() {
		return new AbilityResult<TargetPlayerAbility>(this, true);
	}

	public AbilityResult<TargetPlayerAbility> execute(PlayerInteractEvent event) {
		if (!mayExecute())
			return new AbilityResult<TargetPlayerAbility>(this, false);
